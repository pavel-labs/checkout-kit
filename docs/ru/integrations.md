...
сравнить. Сначала прочитайте [Как написать платёжный плагин](./plugin-authoring.md) —
там про `confirm`, `resume`, действия и evidence, — и
[Бэкенд, с которым говорит плагин](./backend.md) про половину, где лежат ключи.
...
В React Native берите их нативно, а не в WebView — см. [гайд по WebView](./webview.md).
...
См. [«Показать код и ждать»](./providers/asia.md#показать-код-и-ждать).
